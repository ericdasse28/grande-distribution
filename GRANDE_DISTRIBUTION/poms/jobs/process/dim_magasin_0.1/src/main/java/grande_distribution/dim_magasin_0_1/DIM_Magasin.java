...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    ...
    static byte[] commonByteArray_GRANDE_DISTRIBUTION_DIM_Magasin = new byte[0];
			    ...
			    public String ZIM_NUMEROMISTRAL;

				public String getZIM_NUMEROMISTRAL () {
		...
		synchronized(commonByteArrayLock_GRANDE_DISTRIBUTION_DIM_Magasin) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ZIM_NUMEROMISTRAL = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ZIM_NUMEROMISTRAL,dos);
    ...
    public String toString() {
		...
		sb.append(",ZIM_NUMEROMISTRAL="+ZIM_NUMEROMISTRAL);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ZIM_ETABLISSEMENT == null) ? 0 : this.ZIM_ETABLISSEMENT.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						if (this.ZIM_ETABLISSEMENT == null) {
							if (other.ZIM_ETABLISSEMENT != null)
								return false;
						
						} else if (!this.ZIM_ETABLISSEMENT.equals(other.ZIM_ETABLISSEMENT))
	...
	public void copyDataTo(row1Struct other) {
		...
		other.ZIM_ETABLISSEMENT = this.ZIM_ETABLISSEMENT;
	            other.ZIM_NUMEROUPSUD = this.ZIM_NUMEROUPSUD;
	            other.ZIM_NUMEROMISTRAL = this.ZIM_NUMEROMISTRAL;
	            other.ZIM_NUMUPSUDDISTRI = this.ZIM_NUMUPSUDDISTRI;
	            other.ZIM_LIBELLE = this.ZIM_LIBELLE;
	            other.ZIM_ABREGE = this.ZIM_ABREGE;
	            other.ZIM_ADRESSE1 = this.ZIM_ADRESSE1;
	            other.ZIM_ADRESSE2 = this.ZIM_ADRESSE2;
	            other.ZIM_ADRESSE3 = this.ZIM_ADRESSE3;
	            other.ZIM_CODEPOSTAL = this.ZIM_CODEPOSTAL;
	            other.ZIM_VILLE = this.ZIM_VILLE;
	            other.ZIM_DIVTERRIT = this.ZIM_DIVTERRIT;
	            other.ZIM_PAYS = this.ZIM_PAYS;
	            other.ZIM_LANGUE = this.ZIM_LANGUE;
	            other.ZIM_TELEPHONE = this.ZIM_TELEPHONE;
	            other.ZIM_FAX = this.ZIM_FAX;
	            other.ZIM_TELEX = this.ZIM_TELEX;
	            other.ZIM_SOCIETE = this.ZIM_SOCIETE;
	            other.ZIM_JURIDIQUE = this.ZIM_JURIDIQUE;
	            other.ZIM_ETABLIE = this.ZIM_ETABLIE;
	            other.ZIM_EMAIL = this.ZIM_EMAIL;
	            other.ZIM_SIRET = this.ZIM_SIRET;
	            other.ZIM_ACTIVITE = this.ZIM_ACTIVITE;
	            other.ZIM_APE = this.ZIM_APE;
	            other.ZIM_ACTIF = this.ZIM_ACTIF;
	            other.ZIM_CHEFMAGASIN = this.ZIM_CHEFMAGASIN;
	            other.ZIM_CHEFMAGPORT = this.ZIM_CHEFMAGPORT;
	            other.ZIM_SECTEUR = this.ZIM_SECTEUR;
	            other.ZIM_CHEFSECTEUR = this.ZIM_CHEFSECTEUR;
	            other.ZIM_CHEFSECTPORT = this.ZIM_CHEFSECTPORT;
	            other.ZIM_CHEFVENTE = this.ZIM_CHEFVENTE;
	            other.ZIM_CHEFVENTEPORT = this.ZIM_CHEFVENTEPORT;
	            other.ZIM_IPFIXE = this.ZIM_IPFIXE;
	            other.ZIM_IDADSL = this.ZIM_IDADSL;
	            other.ZIM_MDPADSL = this.ZIM_MDPADSL;
	            other.ZIM_MDPROUTADSL = this.ZIM_MDPROUTADSL;
	            other.ZIM_INSEE = this.ZIM_INSEE;
	            other.ZIM_REGION = this.ZIM_REGION;
	            other.ZIM_DATEOUV = this.ZIM_DATEOUV;
	            other.ZIM_DATEFERM = this.ZIM_DATEFERM;
	            other.ZIM_DATEUTIL = this.ZIM_DATEUTIL;
	            other.ZIM_DATEDERRENOV = this.ZIM_DATEDERRENOV;
	            other.ZIM_NBCAISSE = this.ZIM_NBCAISSE;
	            other.ZIM_NBTPE = this.ZIM_NBTPE;
	            other.ZIM_TPEMAINT = this.ZIM_TPEMAINT;
	            other.ZIM_TPEHOTLINE = this.ZIM_TPEHOTLINE;
	            other.ZIM_NUMCPTEIPS = this.ZIM_NUMCPTEIPS;
	            other.ZIM_TPENUMSERIE1 = this.ZIM_TPENUMSERIE1;
	            other.ZIM_TPENUMSERIE2 = this.ZIM_TPENUMSERIE2;
	            other.ZIM_TPENUMSERIE3 = this.ZIM_TPENUMSERIE3;
	            other.ZIM_NUMDOMBANQUE = this.ZIM_NUMDOMBANQUE;
	            other.ZIM_BANQUETPE = this.ZIM_BANQUETPE;
	            other.ZIM_BANQUEVERS = this.ZIM_BANQUEVERS;
	            other.ZIM_NUMCOMPTE = this.ZIM_NUMCOMPTE;
	            other.ZIM_ADRVERSEMENT = this.ZIM_ADRVERSEMENT;
	            other.ZIM_CSECTBINOME = this.ZIM_CSECTBINOME;
	            other.ZIM_MDPWEBMISTRAL = this.ZIM_MDPWEBMISTRAL;
	            other.ZIM_TYPECAISSE = this.ZIM_TYPECAISSE;
	            other.ZIM_ENSEIGNE = this.ZIM_ENSEIGNE;
	            other.ZIM_ENTREPOTLIVRE = this.ZIM_ENTREPOTLIVRE;
	            other.ZIM_ADRFTPMAG = this.ZIM_ADRFTPMAG;
	            other.ZIM_CPTEFTP = this.ZIM_CPTEFTP;
	            other.ZIM_MDPFTP = this.ZIM_MDPFTP;
	            other.ZIM_CPTETEAMVPC = this.ZIM_CPTETEAMVPC;
	            other.ZIM_CPTETEAMVC1 = this.ZIM_CPTETEAMVC1;
	            other.ZIM_CPTETEAMVC2 = this.ZIM_CPTETEAMVC2;
	            other.ZIM_CPTETEAMVC3 = this.ZIM_CPTETEAMVC3;
	            other.ZIM_MDPTEAMVPC = this.ZIM_MDPTEAMVPC;
	            other.ZIM_MDPTEAMVC1 = this.ZIM_MDPTEAMVC1;
	            other.ZIM_MDPTEAMVC2 = this.ZIM_MDPTEAMVC2;
	            other.ZIM_MDPTEAMVC3 = this.ZIM_MDPTEAMVC3;
	            other.ZIM_IDCENTRETRAIT = this.ZIM_IDCENTRETRAIT;
	            other.ZIM_SUPERFVENTE = this.ZIM_SUPERFVENTE;
	            other.ZIM_SUPERFANNEX = this.ZIM_SUPERFANNEX;
	            other.ZIM_PEDF1 = this.ZIM_PEDF1;
	            other.ZIM_PEDF2 = this.ZIM_PEDF2;
	            other.ZIM_NUMPDL1 = this.ZIM_NUMPDL1;
	            other.ZIM_NUMPDL2 = this.ZIM_NUMPDL2;
	            other.ZIM_TYPETARIFEDF = this.ZIM_TYPETARIFEDF;
	            other.ZIM_FOURELEC = this.ZIM_FOURELEC;
	            other.ZIM_SIREN = this.ZIM_SIREN;
	            other.ZIM_FREQLIVRAISON = this.ZIM_FREQLIVRAISON;
	            other.ZIM_TELESURVNOM = this.ZIM_TELESURVNOM;
	            other.ZIM_TELESURVCONTAC = this.ZIM_TELESURVCONTAC;
	            other.ZIM_TELESURVTEL = this.ZIM_TELESURVTEL;
	            other.ZIM_VIDSURVNOM = this.ZIM_VIDSURVNOM;
	            other.ZIM_VIDSURVCONTACT = this.ZIM_VIDSURVCONTACT;
	            other.ZIM_VIDSURVTEL = this.ZIM_VIDSURVTEL;
	            other.ZIM_CLIMNOM = this.ZIM_CLIMNOM;
	            other.ZIM_CLIMCONTACT = this.ZIM_CLIMCONTACT;
	            other.ZIM_CLIMTEL = this.ZIM_CLIMTEL;
	            other.ZIM_FROIDPOSNOM = this.ZIM_FROIDPOSNOM;
	            other.ZIM_FROIDPOSCONTAC = this.ZIM_FROIDPOSCONTAC;
	            other.ZIM_FROIDPOSTEL = this.ZIM_FROIDPOSTEL;
	            other.ZIM_FROIDNEGNOM = this.ZIM_FROIDNEGNOM;
	            other.ZIM_FROIDNEGCONTAC = this.ZIM_FROIDNEGCONTAC;
	            other.ZIM_FROIDNEGTEL = this.ZIM_FROIDNEGTEL;
	            other.ZIM_ANTIVOLNOM = this.ZIM_ANTIVOLNOM;
	            other.ZIM_ANTIVOLCONTACT = this.ZIM_ANTIVOLCONTACT;
	            other.ZIM_ANTIVOLTEL = this.ZIM_ANTIVOLTEL;
	            other.ZIM_IPVIDEOSURV = this.ZIM_IPVIDEOSURV;
	            other.ZIM_PROADMINROUT = this.ZIM_PROADMINROUT;
	            other.ZIM_MDPADMINROUT = this.ZIM_MDPADMINROUT;
	            other.ZIM_MAILSECTEUR = this.ZIM_MAILSECTEUR;
	            other.ZIM_TIERSSURV = this.ZIM_TIERSSURV;
	            other.ZIM_TIERSVIDSURV = this.ZIM_TIERSVIDSURV;
	            other.ZIM_CLIMTIERS = this.ZIM_CLIMTIERS;
	            other.ZIM_ANTIVOLTIERS = this.ZIM_ANTIVOLTIERS;
	            other.ZIM_FROIDPOSTIERS = this.ZIM_FROIDPOSTIERS;
	            other.ZIM_FROIDNEGTIERS = this.ZIM_FROIDNEGTIERS;
	            other.ZIM_FAXCLIM = this.ZIM_FAXCLIM;
	            other.ZIM_MAILCLIM = this.ZIM_MAILCLIM;
	            other.ZIM_FAXANTIVOL = this.ZIM_FAXANTIVOL;
	            other.ZIM_MAILANTIVOL = this.ZIM_MAILANTIVOL;
	            other.ZIM_FAXFROIDPOS = this.ZIM_FAXFROIDPOS;
	            other.ZIM_MAILFROIDPOS = this.ZIM_MAILFROIDPOS;
	            other.ZIM_FAXFROIDNEG = this.ZIM_FAXFROIDNEG;
	            other.ZIM_MAILFROIDNEG = this.ZIM_MAILFROIDNEG;
	            other.ZIM_BAILLEURTIERS1 = this.ZIM_BAILLEURTIERS1;
	            other.ZIM_BAILLEURRS1 = this.ZIM_BAILLEURRS1;
	            other.ZIM_BAILLEUR1ADR1 = this.ZIM_BAILLEUR1ADR1;
	            other.ZIM_BAILLEUR1ADR2 = this.ZIM_BAILLEUR1ADR2;
	            other.ZIM_BAILLEUR1ADR3 = this.ZIM_BAILLEUR1ADR3;
	            other.ZIM_BAILLEURCP1 = this.ZIM_BAILLEURCP1;
	            other.ZIM_BAILLEURVILLE1 = this.ZIM_BAILLEURVILLE1;
	            other.ZIM_BAILLEURTEL1 = this.ZIM_BAILLEURTEL1;
	            other.ZIM_BAILLEURFAX1 = this.ZIM_BAILLEURFAX1;
	            other.ZIM_BAILLEURMAIL1 = this.ZIM_BAILLEURMAIL1;
	            other.ZIM_DATEBAIL1 = this.ZIM_DATEBAIL1;
	            other.ZIM_BAILLEURTIERS2 = this.ZIM_BAILLEURTIERS2;
	            other.ZIM_BAILLEURRS2 = this.ZIM_BAILLEURRS2;
	            other.ZIM_BAILLEUR2ADR1 = this.ZIM_BAILLEUR2ADR1;
	            other.ZIM_BAILLEUR2ADR2 = this.ZIM_BAILLEUR2ADR2;
	            other.ZIM_BAILLEUR2ADR3 = this.ZIM_BAILLEUR2ADR3;
	            other.ZIM_BAILLEURCP2 = this.ZIM_BAILLEURCP2;
	            other.ZIM_BAILLEURVILLE2 = this.ZIM_BAILLEURVILLE2;
	            other.ZIM_BAILLEURTEL2 = this.ZIM_BAILLEURTEL2;
	            other.ZIM_BAILLEURFAX2 = this.ZIM_BAILLEURFAX2;
	            other.ZIM_BAILLEURMAIL2 = this.ZIM_BAILLEURMAIL2;
	            other.ZIM_DATEBAIL2 = this.ZIM_DATEBAIL2;
	            other.ZIM_BAILLEURTIERS3 = this.ZIM_BAILLEURTIERS3;
	            other.ZIM_BAILLEURRS3 = this.ZIM_BAILLEURRS3;
	            other.ZIM_BAILLEUR3ADR1 = this.ZIM_BAILLEUR3ADR1;
	            other.ZIM_BAILLEUR3ADR2 = this.ZIM_BAILLEUR3ADR2;
	            other.ZIM_BAILLEUR3ADR3 = this.ZIM_BAILLEUR3ADR3;
	            other.ZIM_BAILLEURCP3 = this.ZIM_BAILLEURCP3;
	            other.ZIM_BAILLEURVILLE3 = this.ZIM_BAILLEURVILLE3;
	            other.ZIM_BAILLEURTEL3 = this.ZIM_BAILLEURTEL3;
	            other.ZIM_BAILLEURFAX3 = this.ZIM_BAILLEURFAX3;
	            other.ZIM_BAILLEURMAIL3 = this.ZIM_BAILLEURMAIL3;
	            other.ZIM_DATEBAIL3 = this.ZIM_DATEBAIL3;
	            other.ZIM_BAILLEURTIERS4 = this.ZIM_BAILLEURTIERS4;
	            other.ZIM_BAILLEURRS4 = this.ZIM_BAILLEURRS4;
	            other.ZIM_BAILLEUR4ADR1 = this.ZIM_BAILLEUR4ADR1;
	            other.ZIM_BAILLEUR4ADR2 = this.ZIM_BAILLEUR4ADR2;
	            other.ZIM_BAILLEUR4ADR3 = this.ZIM_BAILLEUR4ADR3;
	            other.ZIM_BAILLEURCP4 = this.ZIM_BAILLEURCP4;
	            other.ZIM_BAILLEURVILLE4 = this.ZIM_BAILLEURVILLE4;
	            other.ZIM_BAILLEURTEL4 = this.ZIM_BAILLEURTEL4;
	            other.ZIM_BAILLEURFAX4 = this.ZIM_BAILLEURFAX4;
	            other.ZIM_BAILLEURMAIL4 = this.ZIM_BAILLEURMAIL4;
	            other.ZIM_DATEBAIL4 = this.ZIM_DATEBAIL4;
	            other.ZIM_SYNDIC = this.ZIM_SYNDIC;
	            other.ZIM_SYNDICRS = this.ZIM_SYNDICRS;
	            other.ZIM_SYNDICADR1 = this.ZIM_SYNDICADR1;
	            other.ZIM_SYNDICADR2 = this.ZIM_SYNDICADR2;
	            other.ZIM_SYNDICADR3 = this.ZIM_SYNDICADR3;
	            other.ZIM_SYNDICCP = this.ZIM_SYNDICCP;
	            other.ZIM_SYNDICVILLE = this.ZIM_SYNDICVILLE;
	            other.ZIM_SYNDICTEL = this.ZIM_SYNDICTEL;
	            other.ZIM_SYNDICFAX = this.ZIM_SYNDICFAX;
	            other.ZIM_SYNDICMAIL = this.ZIM_SYNDICMAIL;
	            other.ZIM_LUNDIMDEB = this.ZIM_LUNDIMDEB;
	            other.ZIM_LUNDIMFIN = this.ZIM_LUNDIMFIN;
	            other.ZIM_LUNDIAPDEB = this.ZIM_LUNDIAPDEB;
	            other.ZIM_LUNDIAPFIN = this.ZIM_LUNDIAPFIN;
	            other.ZIM_MARDIMDEB = this.ZIM_MARDIMDEB;
	            other.ZIM_MARDIMFIN = this.ZIM_MARDIMFIN;
	            other.ZIM_MARDIAPDEB = this.ZIM_MARDIAPDEB;
	            other.ZIM_MARDIAPFIN = this.ZIM_MARDIAPFIN;
	            other.ZIM_MERCREDIMDEB = this.ZIM_MERCREDIMDEB;
	            other.ZIM_MERCREDIMFIN = this.ZIM_MERCREDIMFIN;
	            other.ZIM_MERCREDIAPDEB = this.ZIM_MERCREDIAPDEB;
	            other.ZIM_MERCREDIAPFIN = this.ZIM_MERCREDIAPFIN;
	            other.ZIM_JEUDIMDEB = this.ZIM_JEUDIMDEB;
	            other.ZIM_JEUDIMFIN = this.ZIM_JEUDIMFIN;
	            other.ZIM_JEUDIAPDEB = this.ZIM_JEUDIAPDEB;
	            other.ZIM_JEUDIAPFIN = this.ZIM_JEUDIAPFIN;
	            other.ZIM_VENDREDIMDEB = this.ZIM_VENDREDIMDEB;
	            other.ZIM_VENDREDIMFIN = this.ZIM_VENDREDIMFIN;
	            other.ZIM_VENDREDIAPDEB = this.ZIM_VENDREDIAPDEB;
	            other.ZIM_VENDREDIAPFIN = this.ZIM_VENDREDIAPFIN;
	            other.ZIM_SAMEDIMDEB = this.ZIM_SAMEDIMDEB;
	            other.ZIM_SAMEDIMFIN = this.ZIM_SAMEDIMFIN;
	            other.ZIM_SAMEDIAPDEB = this.ZIM_SAMEDIAPDEB;
	            other.ZIM_SAMEDIAPFIN = this.ZIM_SAMEDIAPFIN;
	            other.ZIM_DIMANCHEMDEB = this.ZIM_DIMANCHEMDEB;
	            other.ZIM_DIMANCHEMFIN = this.ZIM_DIMANCHEMFIN;
	            other.ZIM_DIMANCHEAPDEB = this.ZIM_DIMANCHEAPDEB;
	            other.ZIM_DIMANCHEAPFIN = this.ZIM_DIMANCHEAPFIN;
	            other.ZIM_DATECREATION = this.ZIM_DATECREATION;
	            other.ZIM_DATEMODIF = this.ZIM_DATEMODIF;
	            other.ZIM_CREATEUR = this.ZIM_CREATEUR;
	            other.ZIM_UTILISATEUR = this.ZIM_UTILISATEUR;
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.ZIM_ETABLISSEMENT, other.ZIM_ETABLISSEMENT);
						if(returnValue != 0) {
							return returnValue;
						}
...
int count_tDBOutput_1=0;
	    ...
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "magasin" + "` WHERE `code_etablissement` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "magasin" + "` (`code_etablissement`,`adresse`,`code_postal`,`ville`) VALUES (?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "magasin" + "` SET `adresse` = ?,`code_postal` = ?,`ville` = ? WHERE `code_etablissement` = ?";
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.ZIM_NUMEROMISTRAL == null) ? 0 : this.ZIM_NUMEROMISTRAL.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.ZIM_NUMEROMISTRAL == null) {
										if (other.ZIM_NUMEROMISTRAL != null) 
											return false;
								
									} else if (!this.ZIM_NUMEROMISTRAL.equals(other.ZIM_NUMEROMISTRAL))
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_NUMEROUPSUD", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.ZIM_NUMEROMISTRAL = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 21;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_SIRET", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 24;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_ACTIF", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 36;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_INSEE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 38;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEOUV", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 39;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEFERM", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 40;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEUTIL", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 41;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEDERRENOV", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 42;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_NBCAISSE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 43;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_NBTPE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 50;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_NUMDOMBANQUE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 61;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_CPTEFTP", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 62;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_MDPFTP", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 64;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_CPTETEAMVC1", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 65;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_CPTETEAMVC2", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 72;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_SUPERFVENTE", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 73;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_SUPERFANNEX", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 74;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_PEDF1", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 75;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_PEDF2", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 76;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_NUMPDL1", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 80;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_SIREN", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 118;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_BAILLEURTIERS1", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 128;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEBAIL1", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					public void valueToConn_2(org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_1,row1Struct row1 ) throws java.lang.Exception{
					...
					columnIndexWithD_tFileInputDelimited_1 = 201;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ZIM_DATEMODIF", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/deric/Documents/Formation DTA Ingénierie/Projet magasin distribution/Sujet/données/MAGASINS.txt", "UTF-8","\t","\n",false,1,0,
...
row3 = null;			
if(row1.ZIM_NUMEROMISTRAL == null){
	finder_tUniqRow_1.ZIM_NUMEROMISTRAL = null;
}else{
	finder_tUniqRow_1.ZIM_NUMEROMISTRAL = row1.ZIM_NUMEROMISTRAL.toLowerCase();
}	
...
if(row1.ZIM_NUMEROMISTRAL == null){
	new_tUniqRow_1.ZIM_NUMEROMISTRAL = null;
}else{
	new_tUniqRow_1.ZIM_NUMEROMISTRAL = row1.ZIM_NUMEROMISTRAL.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.ZIM_ETABLISSEMENT = row1.ZIM_ETABLISSEMENT;			row3.ZIM_NUMEROUPSUD = row1.ZIM_NUMEROUPSUD;			row3.ZIM_NUMEROMISTRAL = row1.ZIM_NUMEROMISTRAL;			row3.ZIM_NUMUPSUDDISTRI = row1.ZIM_NUMUPSUDDISTRI;			row3.ZIM_LIBELLE = row1.ZIM_LIBELLE;			row3.ZIM_ABREGE = row1.ZIM_ABREGE;			row3.ZIM_ADRESSE1 = row1.ZIM_ADRESSE1;			row3.ZIM_ADRESSE2 = row1.ZIM_ADRESSE2;			row3.ZIM_ADRESSE3 = row1.ZIM_ADRESSE3;			row3.ZIM_CODEPOSTAL = row1.ZIM_CODEPOSTAL;			row3.ZIM_VILLE = row1.ZIM_VILLE;			row3.ZIM_DIVTERRIT = row1.ZIM_DIVTERRIT;			row3.ZIM_PAYS = row1.ZIM_PAYS;			row3.ZIM_LANGUE = row1.ZIM_LANGUE;			row3.ZIM_TELEPHONE = row1.ZIM_TELEPHONE;			row3.ZIM_FAX = row1.ZIM_FAX;			row3.ZIM_TELEX = row1.ZIM_TELEX;			row3.ZIM_SOCIETE = row1.ZIM_SOCIETE;			row3.ZIM_JURIDIQUE = row1.ZIM_JURIDIQUE;			row3.ZIM_ETABLIE = row1.ZIM_ETABLIE;			row3.ZIM_EMAIL = row1.ZIM_EMAIL;			row3.ZIM_SIRET = row1.ZIM_SIRET;			row3.ZIM_ACTIVITE = row1.ZIM_ACTIVITE;			row3.ZIM_APE = row1.ZIM_APE;			row3.ZIM_ACTIF = row1.ZIM_ACTIF;			row3.ZIM_CHEFMAGASIN = row1.ZIM_CHEFMAGASIN;			row3.ZIM_CHEFMAGPORT = row1.ZIM_CHEFMAGPORT;			row3.ZIM_SECTEUR = row1.ZIM_SECTEUR;			row3.ZIM_CHEFSECTEUR = row1.ZIM_CHEFSECTEUR;			row3.ZIM_CHEFSECTPORT = row1.ZIM_CHEFSECTPORT;			row3.ZIM_CHEFVENTE = row1.ZIM_CHEFVENTE;			row3.ZIM_CHEFVENTEPORT = row1.ZIM_CHEFVENTEPORT;			row3.ZIM_IPFIXE = row1.ZIM_IPFIXE;			row3.ZIM_IDADSL = row1.ZIM_IDADSL;			row3.ZIM_MDPADSL = row1.ZIM_MDPADSL;			row3.ZIM_MDPROUTADSL = row1.ZIM_MDPROUTADSL;			row3.ZIM_INSEE = row1.ZIM_INSEE;			row3.ZIM_REGION = row1.ZIM_REGION;			row3.ZIM_DATEOUV = row1.ZIM_DATEOUV;			row3.ZIM_DATEFERM = row1.ZIM_DATEFERM;			row3.ZIM_DATEUTIL = row1.ZIM_DATEUTIL;			row3.ZIM_DATEDERRENOV = row1.ZIM_DATEDERRENOV;			row3.ZIM_NBCAISSE = row1.ZIM_NBCAISSE;			row3.ZIM_NBTPE = row1.ZIM_NBTPE;			row3.ZIM_TPEMAINT = row1.ZIM_TPEMAINT;			row3.ZIM_TPEHOTLINE = row1.ZIM_TPEHOTLINE;			row3.ZIM_NUMCPTEIPS = row1.ZIM_NUMCPTEIPS;			row3.ZIM_TPENUMSERIE1 = row1.ZIM_TPENUMSERIE1;			row3.ZIM_TPENUMSERIE2 = row1.ZIM_TPENUMSERIE2;			row3.ZIM_TPENUMSERIE3 = row1.ZIM_TPENUMSERIE3;			row3.ZIM_NUMDOMBANQUE = row1.ZIM_NUMDOMBANQUE;			row3.ZIM_BANQUETPE = row1.ZIM_BANQUETPE;			row3.ZIM_BANQUEVERS = row1.ZIM_BANQUEVERS;			row3.ZIM_NUMCOMPTE = row1.ZIM_NUMCOMPTE;			row3.ZIM_ADRVERSEMENT = row1.ZIM_ADRVERSEMENT;			row3.ZIM_CSECTBINOME = row1.ZIM_CSECTBINOME;			row3.ZIM_MDPWEBMISTRAL = row1.ZIM_MDPWEBMISTRAL;			row3.ZIM_TYPECAISSE = row1.ZIM_TYPECAISSE;			row3.ZIM_ENSEIGNE = row1.ZIM_ENSEIGNE;			row3.ZIM_ENTREPOTLIVRE = row1.ZIM_ENTREPOTLIVRE;			row3.ZIM_ADRFTPMAG = row1.ZIM_ADRFTPMAG;			row3.ZIM_CPTEFTP = row1.ZIM_CPTEFTP;			row3.ZIM_MDPFTP = row1.ZIM_MDPFTP;			row3.ZIM_CPTETEAMVPC = row1.ZIM_CPTETEAMVPC;			row3.ZIM_CPTETEAMVC1 = row1.ZIM_CPTETEAMVC1;			row3.ZIM_CPTETEAMVC2 = row1.ZIM_CPTETEAMVC2;			row3.ZIM_CPTETEAMVC3 = row1.ZIM_CPTETEAMVC3;			row3.ZIM_MDPTEAMVPC = row1.ZIM_MDPTEAMVPC;			row3.ZIM_MDPTEAMVC1 = row1.ZIM_MDPTEAMVC1;			row3.ZIM_MDPTEAMVC2 = row1.ZIM_MDPTEAMVC2;			row3.ZIM_MDPTEAMVC3 = row1.ZIM_MDPTEAMVC3;			row3.ZIM_IDCENTRETRAIT = row1.ZIM_IDCENTRETRAIT;			row3.ZIM_SUPERFVENTE = row1.ZIM_SUPERFVENTE;			row3.ZIM_SUPERFANNEX = row1.ZIM_SUPERFANNEX;			row3.ZIM_PEDF1 = row1.ZIM_PEDF1;			row3.ZIM_PEDF2 = row1.ZIM_PEDF2;			row3.ZIM_NUMPDL1 = row1.ZIM_NUMPDL1;			row3.ZIM_NUMPDL2 = row1.ZIM_NUMPDL2;			row3.ZIM_TYPETARIFEDF = row1.ZIM_TYPETARIFEDF;			row3.ZIM_FOURELEC = row1.ZIM_FOURELEC;			row3.ZIM_SIREN = row1.ZIM_SIREN;			row3.ZIM_FREQLIVRAISON = row1.ZIM_FREQLIVRAISON;			row3.ZIM_TELESURVNOM = row1.ZIM_TELESURVNOM;			row3.ZIM_TELESURVCONTAC = row1.ZIM_TELESURVCONTAC;			row3.ZIM_TELESURVTEL = row1.ZIM_TELESURVTEL;			row3.ZIM_VIDSURVNOM = row1.ZIM_VIDSURVNOM;			row3.ZIM_VIDSURVCONTACT = row1.ZIM_VIDSURVCONTACT;			row3.ZIM_VIDSURVTEL = row1.ZIM_VIDSURVTEL;			row3.ZIM_CLIMNOM = row1.ZIM_CLIMNOM;			row3.ZIM_CLIMCONTACT = row1.ZIM_CLIMCONTACT;			row3.ZIM_CLIMTEL = row1.ZIM_CLIMTEL;			row3.ZIM_FROIDPOSNOM = row1.ZIM_FROIDPOSNOM;			row3.ZIM_FROIDPOSCONTAC = row1.ZIM_FROIDPOSCONTAC;			row3.ZIM_FROIDPOSTEL = row1.ZIM_FROIDPOSTEL;			row3.ZIM_FROIDNEGNOM = row1.ZIM_FROIDNEGNOM;			row3.ZIM_FROIDNEGCONTAC = row1.ZIM_FROIDNEGCONTAC;			row3.ZIM_FROIDNEGTEL = row1.ZIM_FROIDNEGTEL;			row3.ZIM_ANTIVOLNOM = row1.ZIM_ANTIVOLNOM;			row3.ZIM_ANTIVOLCONTACT = row1.ZIM_ANTIVOLCONTACT;			row3.ZIM_ANTIVOLTEL = row1.ZIM_ANTIVOLTEL;			row3.ZIM_IPVIDEOSURV = row1.ZIM_IPVIDEOSURV;			row3.ZIM_PROADMINROUT = row1.ZIM_PROADMINROUT;			row3.ZIM_MDPADMINROUT = row1.ZIM_MDPADMINROUT;			row3.ZIM_MAILSECTEUR = row1.ZIM_MAILSECTEUR;			row3.ZIM_TIERSSURV = row1.ZIM_TIERSSURV;			row3.ZIM_TIERSVIDSURV = row1.ZIM_TIERSVIDSURV;			row3.ZIM_CLIMTIERS = row1.ZIM_CLIMTIERS;			row3.ZIM_ANTIVOLTIERS = row1.ZIM_ANTIVOLTIERS;			row3.ZIM_FROIDPOSTIERS = row1.ZIM_FROIDPOSTIERS;			row3.ZIM_FROIDNEGTIERS = row1.ZIM_FROIDNEGTIERS;			row3.ZIM_FAXCLIM = row1.ZIM_FAXCLIM;			row3.ZIM_MAILCLIM = row1.ZIM_MAILCLIM;			row3.ZIM_FAXANTIVOL = row1.ZIM_FAXANTIVOL;			row3.ZIM_MAILANTIVOL = row1.ZIM_MAILANTIVOL;			row3.ZIM_FAXFROIDPOS = row1.ZIM_FAXFROIDPOS;			row3.ZIM_MAILFROIDPOS = row1.ZIM_MAILFROIDPOS;			row3.ZIM_FAXFROIDNEG = row1.ZIM_FAXFROIDNEG;			row3.ZIM_MAILFROIDNEG = row1.ZIM_MAILFROIDNEG;			row3.ZIM_BAILLEURTIERS1 = row1.ZIM_BAILLEURTIERS1;			row3.ZIM_BAILLEURRS1 = row1.ZIM_BAILLEURRS1;			row3.ZIM_BAILLEUR1ADR1 = row1.ZIM_BAILLEUR1ADR1;			row3.ZIM_BAILLEUR1ADR2 = row1.ZIM_BAILLEUR1ADR2;			row3.ZIM_BAILLEUR1ADR3 = row1.ZIM_BAILLEUR1ADR3;			row3.ZIM_BAILLEURCP1 = row1.ZIM_BAILLEURCP1;			row3.ZIM_BAILLEURVILLE1 = row1.ZIM_BAILLEURVILLE1;			row3.ZIM_BAILLEURTEL1 = row1.ZIM_BAILLEURTEL1;			row3.ZIM_BAILLEURFAX1 = row1.ZIM_BAILLEURFAX1;			row3.ZIM_BAILLEURMAIL1 = row1.ZIM_BAILLEURMAIL1;			row3.ZIM_DATEBAIL1 = row1.ZIM_DATEBAIL1;			row3.ZIM_BAILLEURTIERS2 = row1.ZIM_BAILLEURTIERS2;			row3.ZIM_BAILLEURRS2 = row1.ZIM_BAILLEURRS2;			row3.ZIM_BAILLEUR2ADR1 = row1.ZIM_BAILLEUR2ADR1;			row3.ZIM_BAILLEUR2ADR2 = row1.ZIM_BAILLEUR2ADR2;			row3.ZIM_BAILLEUR2ADR3 = row1.ZIM_BAILLEUR2ADR3;			row3.ZIM_BAILLEURCP2 = row1.ZIM_BAILLEURCP2;			row3.ZIM_BAILLEURVILLE2 = row1.ZIM_BAILLEURVILLE2;			row3.ZIM_BAILLEURTEL2 = row1.ZIM_BAILLEURTEL2;			row3.ZIM_BAILLEURFAX2 = row1.ZIM_BAILLEURFAX2;			row3.ZIM_BAILLEURMAIL2 = row1.ZIM_BAILLEURMAIL2;			row3.ZIM_DATEBAIL2 = row1.ZIM_DATEBAIL2;			row3.ZIM_BAILLEURTIERS3 = row1.ZIM_BAILLEURTIERS3;			row3.ZIM_BAILLEURRS3 = row1.ZIM_BAILLEURRS3;			row3.ZIM_BAILLEUR3ADR1 = row1.ZIM_BAILLEUR3ADR1;			row3.ZIM_BAILLEUR3ADR2 = row1.ZIM_BAILLEUR3ADR2;			row3.ZIM_BAILLEUR3ADR3 = row1.ZIM_BAILLEUR3ADR3;			row3.ZIM_BAILLEURCP3 = row1.ZIM_BAILLEURCP3;			row3.ZIM_BAILLEURVILLE3 = row1.ZIM_BAILLEURVILLE3;			row3.ZIM_BAILLEURTEL3 = row1.ZIM_BAILLEURTEL3;			row3.ZIM_BAILLEURFAX3 = row1.ZIM_BAILLEURFAX3;			row3.ZIM_BAILLEURMAIL3 = row1.ZIM_BAILLEURMAIL3;			row3.ZIM_DATEBAIL3 = row1.ZIM_DATEBAIL3;			row3.ZIM_BAILLEURTIERS4 = row1.ZIM_BAILLEURTIERS4;			row3.ZIM_BAILLEURRS4 = row1.ZIM_BAILLEURRS4;			row3.ZIM_BAILLEUR4ADR1 = row1.ZIM_BAILLEUR4ADR1;			row3.ZIM_BAILLEUR4ADR2 = row1.ZIM_BAILLEUR4ADR2;			row3.ZIM_BAILLEUR4ADR3 = row1.ZIM_BAILLEUR4ADR3;			row3.ZIM_BAILLEURCP4 = row1.ZIM_BAILLEURCP4;			row3.ZIM_BAILLEURVILLE4 = row1.ZIM_BAILLEURVILLE4;			row3.ZIM_BAILLEURTEL4 = row1.ZIM_BAILLEURTEL4;			row3.ZIM_BAILLEURFAX4 = row1.ZIM_BAILLEURFAX4;			row3.ZIM_BAILLEURMAIL4 = row1.ZIM_BAILLEURMAIL4;			row3.ZIM_DATEBAIL4 = row1.ZIM_DATEBAIL4;			row3.ZIM_SYNDIC = row1.ZIM_SYNDIC;			row3.ZIM_SYNDICRS = row1.ZIM_SYNDICRS;			row3.ZIM_SYNDICADR1 = row1.ZIM_SYNDICADR1;			row3.ZIM_SYNDICADR2 = row1.ZIM_SYNDICADR2;			row3.ZIM_SYNDICADR3 = row1.ZIM_SYNDICADR3;			row3.ZIM_SYNDICCP = row1.ZIM_SYNDICCP;			row3.ZIM_SYNDICVILLE = row1.ZIM_SYNDICVILLE;			row3.ZIM_SYNDICTEL = row1.ZIM_SYNDICTEL;			row3.ZIM_SYNDICFAX = row1.ZIM_SYNDICFAX;			row3.ZIM_SYNDICMAIL = row1.ZIM_SYNDICMAIL;			row3.ZIM_LUNDIMDEB = row1.ZIM_LUNDIMDEB;			row3.ZIM_LUNDIMFIN = row1.ZIM_LUNDIMFIN;			row3.ZIM_LUNDIAPDEB = row1.ZIM_LUNDIAPDEB;			row3.ZIM_LUNDIAPFIN = row1.ZIM_LUNDIAPFIN;			row3.ZIM_MARDIMDEB = row1.ZIM_MARDIMDEB;			row3.ZIM_MARDIMFIN = row1.ZIM_MARDIMFIN;			row3.ZIM_MARDIAPDEB = row1.ZIM_MARDIAPDEB;			row3.ZIM_MARDIAPFIN = row1.ZIM_MARDIAPFIN;			row3.ZIM_MERCREDIMDEB = row1.ZIM_MERCREDIMDEB;			row3.ZIM_MERCREDIMFIN = row1.ZIM_MERCREDIMFIN;			row3.ZIM_MERCREDIAPDEB = row1.ZIM_MERCREDIAPDEB;			row3.ZIM_MERCREDIAPFIN = row1.ZIM_MERCREDIAPFIN;			row3.ZIM_JEUDIMDEB = row1.ZIM_JEUDIMDEB;			row3.ZIM_JEUDIMFIN = row1.ZIM_JEUDIMFIN;			row3.ZIM_JEUDIAPDEB = row1.ZIM_JEUDIAPDEB;			row3.ZIM_JEUDIAPFIN = row1.ZIM_JEUDIAPFIN;			row3.ZIM_VENDREDIMDEB = row1.ZIM_VENDREDIMDEB;			row3.ZIM_VENDREDIMFIN = row1.ZIM_VENDREDIMFIN;			row3.ZIM_VENDREDIAPDEB = row1.ZIM_VENDREDIAPDEB;			row3.ZIM_VENDREDIAPFIN = row1.ZIM_VENDREDIAPFIN;			row3.ZIM_SAMEDIMDEB = row1.ZIM_SAMEDIMDEB;			row3.ZIM_SAMEDIMFIN = row1.ZIM_SAMEDIMFIN;			row3.ZIM_SAMEDIAPDEB = row1.ZIM_SAMEDIAPDEB;			row3.ZIM_SAMEDIAPFIN = row1.ZIM_SAMEDIAPFIN;			row3.ZIM_DIMANCHEMDEB = row1.ZIM_DIMANCHEMDEB;			row3.ZIM_DIMANCHEMFIN = row1.ZIM_DIMANCHEMFIN;			row3.ZIM_DIMANCHEAPDEB = row1.ZIM_DIMANCHEAPDEB;			row3.ZIM_DIMANCHEAPFIN = row1.ZIM_DIMANCHEAPFIN;			row3.ZIM_DATECREATION = row1.ZIM_DATECREATION;			row3.ZIM_DATEMODIF = row1.ZIM_DATEMODIF;			row3.ZIM_CREATEUR = row1.ZIM_CREATEUR;			row3.ZIM_UTILISATEUR = row1.ZIM_UTILISATEUR;					
...
dim_magasin_tmp.code_etablissement = row1.ZIM_NUMEROMISTRAL ;
...
} else {pstmt_tDBOutput_1.setString(1, dim_magasin.code_etablissement);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, dim_magasin.adresse);
}

                        if(dim_magasin.code_postal == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, dim_magasin.code_postal);
}

                        if(dim_magasin.ville == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, dim_magasin.ville);
}

                        if(dim_magasin.code_etablissement == null) {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, dim_magasin.code_etablissement);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, dim_magasin.code_etablissement);
}

                        if(dim_magasin.adresse == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, dim_magasin.adresse);
}

                        if(dim_magasin.code_postal == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, dim_magasin.code_postal);
}

                        if(dim_magasin.ville == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, dim_magasin.ville);
}
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row2.code_etablissement)							
				);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DIM_Magasin.class.getClassLoader().getResourceAsStream("grande_distribution/dim_magasin_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DIM_Magasin.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     284868 characters generated by Talend Open Studio for Data Integration 
 *     on the April 14, 2020 at 11:37:49 AM CEST
 ************************************************************************************************/